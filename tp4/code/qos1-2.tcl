...
$q(E1C0) addPolicyEntry [$Cli2 id] [$Cli5 id] TokenBucket 10 $cir0 $cbs0
$q(E1C0) addPolicyEntry [$Cli3 id] [$Cli4 id] TokenBucket 10 $cir0 $cbs0
$q(E1C0) addPolicyEntry [$Cli4 id] [$Cli3 id] TokenBucket 10 $cir0 $cbs0
$q(E1C0) addPolicyEntry [$Cli5 id] [$Cli2 id] TokenBucket 10 $cir0 $cbs0
$q(E1C0) addPolicyEntry [$Cli6 id] [$Cli1 id] TokenBucket 10 $cir0 $cbs0
...
$q(E2C0) addPolicyEntry [$Cli5 id] [$Cli2 id] TokenBucket 10 $cir0 $cbs0
$q(E2C0) addPolicyEntry [$Cli4 id] [$Cli3 id] TokenBucket 10 $cir0 $cbs0
$q(E2C0) addPolicyEntry [$Cli3 id] [$Cli4 id] TokenBucket 10 $cir0 $cbs0
$q(E2C0) addPolicyEntry [$Cli2 id] [$Cli5 id] TokenBucket 10 $cir0 $cbs0
$q(E2C0) addPolicyEntry [$Cli1 id] [$Cli6 id] TokenBucket 10 $cir0 $cbs0
...
proc printQueueStats {} {
	...
	$q(C0E2) printStats
	puts "\nEstatisticas da Fila de Espera de E2 para C0"
	$q(E2C0) printStats
	puts "\n--------------------------------------------"
